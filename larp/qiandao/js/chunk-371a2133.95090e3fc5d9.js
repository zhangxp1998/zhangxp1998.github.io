  ...
  ["chunk-371a2133"],
  {
    "77e6": function (t, e, s) {
      ...
      var a = function () {
        ...
        b = {
          ...
          setup() {
            const { proxy: t } = Object(l["getCurrentInstance"])(),
              ...
              r = (e) => {
                t.navigateTo({
                  url: "/pages-community/post/spu-detail?postId=" + e.id,
                });
              },
              o = async (e) => {
                t.$router.push("/plugin/Genshin?postId=" + e.id);
              };
            return (
              n(!0),
              {
        ...
        m = b,
        f = (s("bdb8"), s("0c7c")),
        k = Object(f["a"])(m, a, n, !1, null, "583a7f15", null);
      e["default"] = k.exports;
    },
    "81bb": function (t, e, s) {},
    bdb8: function (t, e, s) {
